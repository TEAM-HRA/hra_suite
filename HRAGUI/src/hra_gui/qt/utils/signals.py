...
ADD_TAB_ITEM_WIDGET_SIGNAL = SIGNAL("add_tab_widget(PyQt_PyObject, PyQt_PyObject, PyQt_PyObject, bool)") # @IgnorePep8
...
#hra_gui.qt.custom_widgets.tabwidget.TabWidgetCallableCloseHandler.__call__(self)  # @IgnorePep8
TAB_WIDGET_CLOSE_SIGNAL = SIGNAL('tab_widget_close_signal()')

#signal emitted when a new activity is added by
#hra_gui.qt.activities.activities.ActivityManager.saveActivity method
