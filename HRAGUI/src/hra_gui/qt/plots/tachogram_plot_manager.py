...
try:
    ...
    from hra_gui.qt.plots.tachogram_plot_composite_widget import TachogramPlotCompositeWidget # @IgnorePep8
    from hra_gui.qt.plots.tachogram_plot_summary_composite_widget import TachogramPlotSummaryCompositeWidget # @IgnorePep8
