...
try:
    ...
    from hra_gui.qt.utils.signals import TAB_WIDGET_ADDED_SIGNAL
    from hra_gui.qt.utils.signals import SignalDispatcher
    from hra_gui.qt.utils.signals import ENABLEMEND_SIGNAL
    from hra_gui.qt.widgets.commons import maximize_widget
    from hra_gui.qt.widgets.commons import restore_widget
    from hra_gui.qt.widgets.splitter_widget import SplitterWidget
    from hra_gui.qt.custom_widgets.tabwidget import TabWidgetItemCommon
    ...
    from hra_gui.qt.plots.tachogram_plot_manager import TachogramPlotManager
    from hra_gui.qt.plots.tachogram_plot_datasource_list_widget import TachogramPlotDatasourceListWidget # @IgnorePep8
