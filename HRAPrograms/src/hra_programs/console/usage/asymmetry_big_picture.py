...
ax_arrow_down.autoscale_view('tight')
...
ax_tachogram = plt.subplot(gs1[2, :])
...
ax_arrow_left = plt.subplot(gs1[3,0])
...
ax_arrow_left.autoscale_view('tight')
...
ax_arrow_right = plt.subplot(gs1[3,1])
...
ax_arrow_right.autoscale_view('tight')
#ax_arrow_left.add_collection(collection)
ax_arrow_right.add_patch(arrow_right)

# LEFT TACHOGRAM START
ax_left_tachogram = plt.subplot(gs1[4,0])
...
ax_right_tachogram = plt.subplot(gs1[4,1])
