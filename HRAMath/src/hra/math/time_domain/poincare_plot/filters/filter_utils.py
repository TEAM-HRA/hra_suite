...
try:
    from hra.core.collections_utils import remove_suffix
...
def get_filters_subclasses():
    ...
    """
    from hra.math.time_domain.poincare_plot.filters.annotation_filter import AnnotationFilter # @IgnorePep8
    from hra.math.time_domain.poincare_plot.filters.square_filter import SquareFilter # @IgnorePep8    
