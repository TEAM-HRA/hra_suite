...
try:
    ...
    from hra.math.time_domain.poincare_plot.filters.filter_utils import expand_to_real_filters_names # @IgnorePep8
    from hra.math.time_domain.poincare_plot.filters.filter_utils import get_package_for_filter # @IgnorePep8
