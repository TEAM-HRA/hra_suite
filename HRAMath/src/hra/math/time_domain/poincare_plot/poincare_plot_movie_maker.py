...
try:
    ...
    from hra.core.misc import ColorRGB
    from hra.core.io_utils import as_path
    from hra.math.time_domain.poincare_plot.poincare_plot_animation \
                                        import PoincarePlotAnimation
    from hra.math.time_domain.poincare_plot.poincare_plot_movie_worker \
