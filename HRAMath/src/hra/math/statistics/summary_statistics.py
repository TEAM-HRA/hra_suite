...
try:
    from hra.core.introspection import create_class_object_with_suffix
    from hra.core.introspection import get_subclasses_names_with_suffix
    from hra.core.introspection import expand_to_real_class_names
    from hra.math.statistics.statistics import C1dStatistic
    from hra.math.statistics.statistics import C2dStatistic
    from hra.math.statistics.statistics import CdStatistic
    from hra.math.statistics.statistics import CountAboveLineIdentityStatistic
    from hra.math.statistics.statistics import CountBelowLineIdentityStatistic
    from hra.math.statistics.statistics import CaStatistic
    from hra.math.statistics.statistics import C1aStatistic
    from hra.math.statistics.statistics import C2aStatistic
            ...
            for type_or_name in summary_statistics_names:
                ...
                if isinstance(type_or_name, str):
                    type_or_name = create_class_object_with_suffix(
                                   'hra.math.statistics.summary_statistics',
