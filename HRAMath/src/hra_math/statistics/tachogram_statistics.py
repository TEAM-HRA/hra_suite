...
try:
    import pylab as pl
    from hra_core.introspection import get_subclasses
    from hra_math.statistics.statistics import Statistic
    from hra_math.statistics.statistics import MeanStatistic
    from hra_math.statistics.statistics import MaxStatistic
    from hra_math.statistics.statistics import MinStatistic
