...
(1) Lomb (highly recommended)  (2) FFT interpolated (3) FFT imputated"""
...
for plik in lista_plikow:
    ...
    file_result.write("%s,%f,%f,%f,%f,%f,%f,%f,%f,%f,%f,%d,%d,%d,%d,%d,%f,%f,%f,%f,%f,%f,%f,%f,%f,%f,%f,%f,%f\n"% (plik, RR_mean,sdrr,rmssd,sd1,sd2,sd21,s,r,sd1up,sd1down,asym,nup,ndown,non,ntot,tot_time, VLF, LF, HF, LFnu, HFnu, TP0_5, TP0_4, LF/HF,log(LF), log(HF), log(TP0_5), log(TP0_4)))
