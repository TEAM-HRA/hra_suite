...
try:
    ...
    from pymath.time_domain.poincare_plot.poincare_plot_movie_parameters \
                                    import PoincarePlotMovieParameters
    ...
    from pygui.qt.custom_widgets.choose_color_widget import ChooseColorWidget
    from pygui.qt.plots.specific_widgets.poincare_plot_movie_generator_progress_bar import PoincarePlotMovieGeneratorProgressBar # @IgnorePep8
...
class PoincarePlotMovieDockWidget(DockWidgetWidget):
    ...
    def __generate_handler__(self):
        ...
        movie_parameters = PoincarePlotMovieParameters()
